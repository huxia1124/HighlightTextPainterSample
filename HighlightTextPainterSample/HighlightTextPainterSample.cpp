// HighlightTextPainterSample.cpp : Defines the entry point for the application.
//

#include "framework.h"
#include "HighlightTextPainterSample.h"
                     ...
                     _In_ int       nCmdShow)
{
    ...
    LoadStringW(hInstance, IDC_HIGHLIGHTTEXTPAINTERSAMPLE, szWindowClass, MAX_LOADSTRING);
    ...
    HACCEL hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_HIGHLIGHTTEXTPAINTERSAMPLE));
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
    ...
    wcex.hIcon          = LoadIcon(hInstance, MAKEINTRESOURCE(IDI_HIGHLIGHTTEXTPAINTERSAMPLE));
    wcex.hCursor        = LoadCursor(nullptr, IDC_ARROW);
    wcex.hbrBackground  = (HBRUSH)(COLOR_WINDOW+1);
    wcex.lpszMenuName   = MAKEINTRESOURCEW(IDC_HIGHLIGHTTEXTPAINTERSAMPLE);
